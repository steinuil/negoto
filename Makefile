...
src_files = $s/negoto.urp $s/admin.ur $s/admin.urs $s/api.ur $s/api.urs $s/data.ur $s/data.urs $s/layout.ur $s/layout.urs $s/logger.ur $s/logger.urs $s/main.ur $s/negoto.ur $s/negoto.urs $s/tags.urs $s/util.ur $(file_lib) $(post_lib) $(uuid_lib)
